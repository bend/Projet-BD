...
<fieldset>   
	...
	<ol>   
		...
		class="text textSmall" type="text"  onblur="javascript:check_is_int(this.value,'post_code_ok');"/>   
...
<input type="button" id="button_ok" disabled="true" value="Edit" onclick="javascript:update_supplier();"/>
<div id="loading"></div>
</fieldset>
