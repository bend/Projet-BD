<fieldset>
	...
	<ol>   
		...
		<input id="active" name="active" readonly="readonly" class="text"   
		...
		<a id="zoom_img"  href="http://">
			<img id="imgpath"   name="imgpath"   width="200" heigth="200" class="text" alt="" onerror="javascript:this.src='img/empty.png'; this.width='0';"/>
		</a>
