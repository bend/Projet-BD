...
<div id="sub_menu_contents">
	...
	<li><a href="javascript:;" onclick="javascript:load_subscreen('subscreens/repository_view_stock.php');">View Stock</a></li><br/>
	<li><a href="javascript:;" onclick="javascript:load_subscreen('subscreens/repository_move_stock.php');">Move Stock</a></li><br/>
	<li><a href="javascript:;" onclick="javascript:load_repo_addresses();">Localise on map</a></li><br/>
</div>
